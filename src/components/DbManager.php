...
namespace mix8872\useradmin\components;
...
{
    const PART_ITEMS = 'mix8872.useradmin.items';
    const PART_CHILDREN = 'mix8872.useradmin.children';
    const PART_RULES = 'mix8872.useradmin.rules';
