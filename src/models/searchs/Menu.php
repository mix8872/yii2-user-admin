...
namespace mix8872\useradmin\models\searchs;

use Yii;
use yii\base\Model;
use yii\data\ActiveDataProvider;
use mix8872\useradmin\models\Menu as MenuModel;

/**
 * Menu represents the model behind the search form about [[\mix8872\useradmin\models\Menu]].
 * 
